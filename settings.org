...
* EXWM
EXWM allows Emacs to be your window manager. In theory this is great, since
you are already familiar with the keybindings. In practice I found it to be
a bit quirky, so I'm no longer using it. I'll keep the configuration for the
time being in case I decide to give it another try.
