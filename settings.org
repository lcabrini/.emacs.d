...
This is my personal Emacs configuration. As most Emacs users, I maintain this as
an org-mode file.

It is currently in a bit of a mess, but I'm working on cleaning it up. The section
called =CLEAN UP= contains all the stuff that needs to be reviewed and put in the
right location.
...
** Org Agenda
I use org-agenda to quickly see what I need to be working on. I want org-agenda
to look for tasks in my inbox and my projects file.
...
* Terminal Emulation
** Vterm
Normally I use ansi-term, but I decided to give vterm a go.
