...
*** Zenburn
This is not a bad theme, but it seems to hurt my eyes. ([[https://github.com/bbatsov/zenburn-emacs][GitHub]])
...
** Todo
I used to have a =STARTED= keyword in the list, but I never really used it.
